...
function readResponseConclusion() {
    const responseFile = process.env.RESPONSE_FILE || "";
    if (!responseFile)
        return "";
    try {
        return (0, handoff_js_1.extractReviewConclusion)((0, node_fs_1.readFileSync)(responseFile, "utf8"));
    }
    catch {
        return "";
    }
...
if (!(0, handoff_js_1.automationModeAllowsHandoff)(automationMode)) {
...
//# sourceMappingURL=dispatch-agent-orchestrator.js.map