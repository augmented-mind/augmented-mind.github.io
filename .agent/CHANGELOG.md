...
- Claude-backed runs now default to the ACP-advertised `opus` model alias so resumed Sepo sessions do not fail model validation on follow-up implementation runs.
